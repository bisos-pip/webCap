...
import typing ; csInfo: typing.Dict[str, typing.Any] = {'category': 'csxu', 'name': 'reactProc-seed.cs', 'features': ['direct', 'uploader', 'seeded']}
...
#+END_SRC
#+RESULTS:
| bisos.csPlayer.csxuFps_csu | bisos.webCap.reactProc_csu | plantedCsu |
#+end_org """
...
csuList = [ 'bisos.csPlayer.csxuFps_csu', 'bisos.webCap.reactProc_csu', 'plantedCsu', ]
