...
####+BEGIN: b:py3:class/decl :className "DjangoProcSeedInfo" :superClass "object" :classType "basic" :deco "@dataclass" :comment "Abstraction of a  Interface"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /DjangoProcSeedInfo/  superClass=object =Abstraction of a  Interface=  [[elisp:(org-cycle)][| ]]
#+end_org """
@dataclass
class DjangoProcSeedInfo(object):
####+END:
    """
** Abstraction of
"""
...
djangoProcSeedInfo = DjangoProcSeedInfo()
...
** [[elisp:(org-cycle)][| *DocStr | ]
    ...
    if examplesFuncsList is not None:
        djangoProcSeedInfo.examplesFuncsList  = examplesFuncsList
        cmnds_seedInfo.setup(
            examplesFuncsList=examplesFuncsList,
        )
    djangoProcSeedInfo.webVirtualDomain = webVirtualDomain
    djangoProcSeedInfo.dev_webPortNu = dev_webPortNu
